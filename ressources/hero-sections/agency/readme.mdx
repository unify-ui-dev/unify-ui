...
```html
<!-- navbar -->
<div bg="gray-8/40" class="fixed inset-0 z30 hidden lg-hidden" data-nav-overlay aria-hidden="true"></div>
<header border-b="~ gray-1 dark:gray-9" bg="white/80 dark:gray-950/80"
    ...
    <nav px="5 sm:10 md:12 lg:5" class="relative mxauto max-w-7xl w-full flex gap-x-5 justify-between items-center">
        ...
        <div lg="top-0 relative w-max flex" bg="white dark:gray-950 lg:transparent"
            ...
            class="translate-y-10 lg:translate-y-0 op-0 lg:op-100 invisible lg-visible ease-linear gap-x-6 absolute top-full left-0 w-full duration-300"
            data-navbar>
            ...
            <div mt="10 lg:0" flex flex-col sm-flex-row sm-items-center gap-4 lg-min-w-max aria-hidden="true">
        ...
        <div flex items-center lg-hidden>
            <button data-toggle-navbar data-is-open="false" outline-none border-l border-l="~ indigo-1 dark:gray-7"
                p-3 relative bg-transparent>
        ...
        <div mx-auto max-w-7xl w-full px="5 sm:10 md:12 lg:5" gap="8 lg:10 xl:12" flex flex-col lg-flex-row>
            <div
                ...
                <div mt10 flex gap-4 justify-center lg-justify-start flex-wrap>
                    ...
                    <a href="#" flex justify-center relative px6 py3
                        before="absolute content-empty inset-0 rd-lg transition bg-gray-1 dark:bg-gray-9 hover:bg-purple-8 hover:scale-105">
                        <span relative text="indigo-6 dark:white">
                            See Project
                        </span>
                    </a>
